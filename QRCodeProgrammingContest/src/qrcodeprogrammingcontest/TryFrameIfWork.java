 ...
 * @author KATOLIKO AKO
 */
public class TryFrameIfWork extends javax.swing.JFrame {

    /**
     * Creates new form TryFrameIfWork
     */
    public TryFrameIfWork() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TryFrameIfWork.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TryFrameIfWork().setVisible(true);
            }
        });
    }
